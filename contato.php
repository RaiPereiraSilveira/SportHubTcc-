...
<section class="section-sm">
    <div class="wrap">
        <div style="display:grid;gap:26px;align-items:start" class="contato-layout">
            <style>
            ...
            <aside>
                <div class="card" style="padding:26px">
                    <h3 style="font-size:1.05rem">Canais diretos</h3>
                    <ul class="stack mt-2">
                        <li><a href="https://wa.me/<?= e(SH_WHATSAPP) ?>" target="_blank" rel="noopener" class="row" style="gap:10px;color:var(--ink-soft)">
                            <i class="fab fa-whatsapp" style="color:#25D366;width:18px"></i> WhatsApp comercial
                        </a></li>
                        <li><a href="mailto:<?= e(SH_EMAIL) ?>" class="row" style="gap:10px;color:var(--ink-soft)">
                            <i class="fas fa-envelope" style="color:var(--ember);width:18px"></i> <?= e(SH_EMAIL) ?>
                        </a></li>
                        <li><a href="mailto:<?= e(SH_EMAIL_DPO) ?>" class="row" style="gap:10px;color:var(--ink-soft)">
                            <i class="fas fa-user-shield" style="color:var(--blue);width:18px"></i> <?= e(SH_EMAIL_DPO) ?>
                        </a></li>
                        <li><a href="<?= e(SH_INSTAGRAM) ?>" target="_blank" rel="noopener" class="row" style="gap:10px;color:var(--ink-soft)">
                            <i class="fab fa-instagram" style="color:#C13584;width:18px"></i> @sporthubgg
                        </a></li>
                    </ul>
                </div>

                <div class="card mt-2" style="padding:26px">
                    <h3 style="font-size:1.05rem">Atalhos úteis</h3>
                    <ul class="stack mt-2">
                        <li><a href="<?= e(sh_url('planos.php')) ?>" class="small" style="color:var(--ember)">Ver planos e preços →</a></li>
                        <li><a href="<?= e(sh_url('como-funciona.php')) ?>" class="small" style="color:var(--ember)">Como funciona a plataforma →</a></li>
                        <li><a href="<?= e(sh_url('cadastro-arbitro.php')) ?>" class="small" style="color:var(--ember)">Credenciamento de árbitros →</a></li>
                        <li><a href="<?= e(sh_url('lgpd.php')) ?>" class="small" style="color:var(--ember)">Portal LGPD →</a></li>
                    </ul>
                </div>
