    ...
    <article class="legal-body">
        ...
        <section id="definicoes">
            ...
            <div class="data-table-wrap">
                <table class="data">
                    <thead><tr><th class="u-width-180px">Termo</th><th>O que significa aqui</th></tr></thead>
                    <tbody>
        ...
        <section id="finalidades">
            ...
            <div class="data-table-wrap">
                <table class="data">
                    <thead><tr><th>Finalidade</th><th class="u-width-230px">Base legal (LGPD)</th><th class="u-width-150px">Dados usados</th></tr></thead>
                    <tbody>
        ...
        <section id="retencao">
            ...
            <div class="data-table-wrap">
                <table class="data">
                    <thead><tr><th>Categoria</th><th class="u-width-220px">Prazo de guarda</th><th>Motivo</th></tr></thead>
                    <tbody>
        ...
        <section id="contato">
            ...
            <div class="data-table-wrap">
                <table class="data">
                    <tbody>
                        <tr><td class="u-width-200px">E-mail do encarregado</td><td><a href="mailto:<?= e(SH_EMAIL_DPO) ?>"><?= e(SH_EMAIL_DPO) ?></a></td></tr>
                        <tr><td class="u-color-muted">Canal com protocolo</td><td><a href="<?= e(sh_url('lgpd.php')) ?>">Portal LGPD do SportHub</a></td></tr>
                        <tr><td class="u-color-muted">Atendimento geral</td><td><a href="mailto:<?= e(SH_EMAIL) ?>"><?= e(SH_EMAIL) ?></a></td></tr>
                        <tr><td class="u-color-muted">Prazo de resposta</td><td>Até 15 dias corridos</td></tr>
                    </tbody>
                </table>
            </div>
            <p>
