...
<!-- ═══════════ CARDS DE PLANO ═══════════ -->
<section class="section-sm u-padding-top-clamp-48px-6vw-72px">
    <div class="wrap">
        ...
        <div class="callout reveal mt-4 u-max-width-820px">
    ...
    <div class="wrap">
        ...
        <div class="compare-wrap reveal">
            <table class="compare">
                <thead>
                    <tr>
                        <th class="u-min-width-240px">Recurso</th>
                        <?php foreach ($planos as $plano): ?>
                            <th class="u-text-align-center"><?= e($plano['nome']) ?></th>
                        <?php endforeach; ?>
                    </tr>
                </thead>
                ...
                <tbody>
                    <tr>
                        <th class="u-background-surface-2-2" colspan="<?= count($planos) + 1 ?>">
                            <?= e($grupo) ?>
                        </th>
                    </tr>
    ...
    <div class="wrap">
        ...
        <div class="grid grid-4">
            <div class="card reveal">
                ...
                <h3 class="u-font-size-1rem">Implantação sem custo</h3>
            ...
            <div class="card reveal">
                ...
                <h3 class="u-font-size-1rem">Atualizações incluídas</h3>
            ...
            <div class="card reveal">
                ...
                <h3 class="u-font-size-1rem">Conformidade LGPD</h3>
            ...
            <div class="card reveal">
                ...
                <h3 class="u-font-size-1rem">Seus dados são seus</h3>
