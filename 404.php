...
<section class="section u-min-height-52vh">
    <div class="wrap-narrow center">
        <span class="pill"><span class="dot"></span> Erro 404</span>
        <h1 class="u-font-size-clamp-3rem-10vw-6rem">Bola fora.</h1>
        <p class="lead u-margin-20pxauto0">
        ...
        <div class="btn-group mt-3 u-justify-content-center">
