    ...
    <article class="legal-body">
        ...
        <section id="necessarios">
            ...
            <div class="data-table-wrap">
                <table class="data">
                    <thead>
                        <tr><th class="u-width-170px">Nome</th><th>Finalidade</th><th class="u-width-150px">Duração</th></tr>
                    </thead>
                    <tbody>
                        <tr>
        ...
        <section id="gerenciar">
            ...
            <p>
                <a href="#" data-abrir-cookies class="btn btn-primary u-text-decoration-none">
