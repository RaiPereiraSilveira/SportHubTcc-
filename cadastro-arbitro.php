...
if ($protocolo_busca !== '' && sh_tabela_existe($pdo, 'arbitro_solicitacoes')) {
    try {
        ...
        sh_log_excecao($e, 'consultar protocolo');
    ...
    if (!$erros) {
        if (!sh_tabela_existe($pdo, 'arbitro_solicitacoes')) {
            ...
            try {
                ...
                sh_log_excecao($e, 'registrar credenciamento');
...
<section class="section-sm">
    <div class="wrap-narrow">
        <div class="form-card">
            ...
            <ol class="mt-1 u-display-grid-2">
    ...
    <div class="wrap">
        ...
        <div class="grid grid-4">
            <div class="card reveal">
                ...
                <h3 class="u-font-size-1rem">Professor de Ed. Física</h3>
            ...
            <div class="card reveal">
                ...
                <h3 class="u-font-size-1rem">Árbitro federado</h3>
            ...
            <div class="card reveal">
                ...
                <h3 class="u-font-size-1rem">Técnico esportivo</h3>
                <p class="small">Com curso técnico ou certificação em arbitragem da modalidade.</p>
            </div>
            <div class="card reveal">
                <div class="card-icon"><i class="fas fa-user-graduate"></i></div>
                <h3 class="u-font-size-1rem">Estudante de licenciatura</h3>
...
<section class="section-sm u-background-surface-2">
    <div class="wrap-narrow">
        <div class="section-head reveal">
            ...
            <p>Leva cerca de 5 minutos. Campos marcados com <span class="u-color-ember">*</span> são obrigatórios.</p>
        </div>
        ...
        <div class="form-card">
            ...
            <form method="POST" enctype="multipart/form-data" novalidate>
                ...
                <fieldset class="fieldset">
                    ...
                    <div class="alert alert-info u-margin-bottom-0">
        ...
        <div class="form-card mt-3">
            <h3><i class="fas fa-magnifying-glass u-color-ember-2"></i> Já enviei — quero acompanhar</h3>
