            ...
            <div class="scoreboard-stack">
                <div class="scoreboard">
                    ...
                    <div class="sb-foot">
                        ...
                        Súmula lançada por <strong class="u-color-rgba-255-255-255-82">árbitro credenciado</strong> · Quadra Poliesportiva
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="marquee" aria-hidden="true">
        ...
        foreach ([1, 2] as $volta):
            foreach ($itens as $item): ?>
                <span class="marquee-item"><i class="fas fa-circle u-font-size-5px"></i> <?= e($item) ?></span>
            <?php endforeach;
        endforeach; ?>
    </div>
</section>
        ...
        <div class="split">
            ...
            <div class="reveal">
                <div class="mini-table">
                    ...
                    <p class="small mt-2 u-color-rgba-255-255-255-42">
...
<section class="section" id="arbitragem">
    <div class="wrap">
        <div class="split reverse">
            <div class="reveal">
                <div class="card u-padding-32px">
                    <div class="row-between mb-3">
                        <div>
                            <div class="role-sub">Credencial de arbitragem</div>
                            <div class="u-font-family-font-display">Prof. Carlos Menezes</div>
                        </div>
                        <span class="tag tag-green"><i class="fas fa-circle-check"></i> Ativa</span>
                    </div>
                    <div class="data-table-wrap u-margin-0">
                        <table class="data u-min-width-0">
                            <tbody>
                                <tr><td class="u-color-muted">Registro</td><td><strong>CREF 012345-G/SP</strong></td></tr>
                                <tr><td class="u-color-muted">Modalidades</td><td>Futsal · Vôlei · Handebol</td></tr>
                                <tr><td class="u-color-muted">Experiência</td><td>8 anos</td></tr>
                                <tr><td class="u-color-muted">Jogos apitados</td><td>147 partidas</td></tr>
                                <tr><td class="u-color-muted">Validade</td><td>31/12/<?= date('Y') + 1 ?></td></tr>
                            </tbody>
                        </table>
                    </div>
                    <p class="small mt-3 u-color-muted-2-2">
...
<!-- ══════════════════ PLANOS ══════════════════ -->
<section class="section u-background-surface-2" id="planos">
    <div class="wrap">
        <div class="section-head center reveal">
...
<section class="section" id="privacidade">
    <div class="wrap">
        <div class="split">
            ...
            <div class="reveal">
                <div class="grid grid-2 u-gap-16px">
                    <div class="card u-padding-24px">
                        <div class="card-icon"><i class="fas fa-shield-halved"></i></div>
                        <h3 class="u-font-size-1rem">Base legal declarada</h3>
                    ...
                    <div class="card u-padding-24px">
                        ...
                        <h3 class="u-font-size-1rem">Canal do DPO</h3>
...
<section class="section">
    <div class="wrap">
        <div class="cta-box reveal">
            ...
            <p class="cta-fine">Já tem conta? <a class="u-color-ember-light" href="<?= e(sh_url('login.php')) ?>">Entrar na plataforma</a></p>
        </div>
    </div>
</section>
