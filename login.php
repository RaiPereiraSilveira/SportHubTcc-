        ...
        try {
            ...
            if ($usuario) {
                if (password_verify($password, $usuario['password'])) {
                    $senha_valida = true;
                } elseif ($password !== '' && hash_equals($usuario['password'], $password)) {
                    // Migração das senhas antigas gravadas em texto puro no seed inicial:
                    // no primeiro login válido a senha é convertida em hash.
                    $senha_valida = true;
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .tabs-nav {
            ...
            background: var(--surface-3); border-radius: 14px; margin-bottom: 28px;
        }
        .tab-btn {
...
<div class="page-wrap">
    ...
    <aside class="hero-panel" role="complementary">
        <div class="hero-logo">
            <div class="hero-logo-icon">
                    ...
                    ?>
                    <img src="<?= htmlspecialchars($logoUrl) ?>" alt="Logo SportHub" style="width:42px; height:42px; object-fit:contain; display:block; border-radius:10px;">
                </div>
    ...
    <main class="form-panel" role="main">
        ...
        <div class="tab-pane active" id="pane-login" role="tabpanel">
            ...
            <p style="text-align:center;font-size:.85rem;color:var(--gray-600);">
                Não possui conta?
                <button type="button" onclick="switchTab('cadastro')" style="background:none;border:none;color:var(--ember);font-weight:600;cursor:pointer;font-size:.85rem;text-decoration:underline;">
        ...
        <div class="tab-pane" id="pane-cadastro" role="tabpanel">
            ...
            <form method="POST" novalidate>
                ...
                <div class="field">
                    <label for="cadastro_email">E-mail <span style="text-transform:none;letter-spacing:0">(opcional)</span></label>
        ...
        <p style="text-align:center;margin-top:16px;color:var(--gray-600);font-size:.9rem;">
            É professor ou árbitro?
            <a href="<?= e(sh_url('cadastro-arbitro.php')) ?>" style="color:var(--ember);text-decoration:underline;font-weight:600;">Solicite seu credenciamento</a>
        </p>
    </main>
...
<div id="lgpd-banner">
    <p>
        <strong style="color:#fff;">🔒 Aviso de Privacidade</strong> — Este sistema coleta dados pessoais exclusivamente
