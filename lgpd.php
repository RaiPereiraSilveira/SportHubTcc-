...
if ($protocolo_busca !== '' && sh_tabela_existe($pdo, 'lgpd_solicitacoes')) {
    try {
        ...
        error_log('Erro ao consultar protocolo LGPD: ' . $e->getMessage());
    ...
    if (!$erros) {
        if (!sh_tabela_existe($pdo, 'lgpd_solicitacoes')) {
            ...
            try {
                ...
                error_log('Erro ao registrar solicitação LGPD: ' . $e->getMessage());
    ...
    <div class="wrap-narrow">
        <div class="form-card">
            ...
            <div class="data-table-wrap">
                <table class="data">
                    <tbody>
                        <tr><td style="width:200px;color:var(--muted)">Tipo de pedido</td><td><strong><?= e($sucesso['tipo']) ?></strong></td></tr>
                        <tr><td style="color:var(--muted)">Recebido em</td><td><?= e(date('d/m/Y \à\s H:i')) ?></td></tr>
                        <tr><td style="color:var(--muted)">Prazo legal de resposta</td><td><strong><?= e($sucesso['prazo']->format('d/m/Y')) ?></strong> (art. 19, II da LGPD)</td></tr>
                        <tr><td style="color:var(--muted)">Situação</td><td><span class="tag tag-blue"><i class="fas fa-inbox"></i> Recebida</span></td></tr>
                    </tbody>
                </table>
            </div>
    ...
    <div class="wrap">
        ...
        <div class="grid grid-4">
            <div class="card reveal">
                ...
                <h3 style="font-size:1rem">Acesso</h3>
            ...
            <div class="card reveal">
                ...
                <h3 style="font-size:1rem">Anonimização</h3>
            ...
            <div class="card reveal">
                ...
                <h3 style="font-size:1rem">Revogação</h3>
...
<section class="section-sm" style="background:var(--surface-2);border-block:1px solid var(--line)">
    <div class="wrap-narrow">
        ...
        <div class="form-card mt-3">
            <h3><i class="fas fa-magnifying-glass" style="color:var(--ember);margin-right:8px"></i> Acompanhar uma solicitação</h3>
    ...
    <div class="wrap">
        ...
        <div class="grid grid-4">
            <a href="<?= e(sh_url('privacidade.php')) ?>" class="card reveal">
                ...
                <h3 style="font-size:1rem">Política de Privacidade</h3>
            ...
            <a href="<?= e(sh_url('termos.php')) ?>" class="card reveal">
                ...
                <h3 style="font-size:1rem">Termos de Uso</h3>
            ...
            <a href="<?= e(sh_url('cookies.php')) ?>" class="card reveal">
                ...
                <h3 style="font-size:1rem">Política de Cookies</h3>
            ...
            <a href="mailto:<?= e(SH_EMAIL_DPO) ?>" class="card reveal">
                ...
                <h3 style="font-size:1rem">Encarregado (DPO)</h3>
